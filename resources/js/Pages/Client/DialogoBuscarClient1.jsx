...
const DialogoBuscarClient1 = (params) => {
    ...
    return (
        <div className="modal border" tabIndex="-1" id='dialogoSearchClients1' role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                ...
                                {clientes.map((item, index) => {
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <a href={route('client.edit', item.cedula)} className='btn btn-success btn-sm' style={{ backgroundColor: 'green' }}>
                                                    Detalles
                                                </a>
                                            </td>
                                        </tr>
...
export default DialogoBuscarClient1