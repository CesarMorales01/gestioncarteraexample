                ...
                <div className="modal-content">
                    ...
                    <div className='container' style={{ margin: '0.2em' }}>
                        ...
                        <form method="POST" id="formCrear" action={route('spend.store')} >
                            ...
                            <input type="hidden" name='cartera' value={params.carteraSeleccionada} />
                            ...
                            <SelectCategoriasNew getCategoriaNew={cambioCategoriaNew} categorias={categorias}></SelectCategoriasNew>
                        ...
                        <div style={{ marginTop: '1em', marginBottom: '1em' }} className="col text-center">
                            <div className="modal-footer">
                                ...
                                <button id='btnAgregarIngreso' onClick={validar} className="btn btn-success btnVerde" type="button" >Ingresar</button>
