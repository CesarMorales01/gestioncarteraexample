...
const Gastos = (params) => {
  ...
  }, [listaGastos, fechas, filtrarCategoria, carteraSeleccionada])
  ...
  function cargarDatos() {
    const url = params.globalVars.myUrl + 'spend/list/bydate/' + fechas.fechaInicio + '/' + fechas.fechaFinal + '/' + carteraSeleccionada + '/' + filtrarCategoria
    fetch(url)
      .then((response) => {
    ...
    >
      ...
      <div className='container'>
        ...
        <div style={{ marginTop: '0.5em' }} className="row justify-content-center">
          ...
          <div align="center" className="col-lg-6 col-md-6 col-sm-12 col-12" >
            <div style={{ width: '82%' }}>
              <div style={{ marginTop: '1em' }} className="form-inline">
                <div style={{ marginLeft: '4em' }} className="input-group">
                  <SelectCategorias getCategoria={cambioCategoria} categorias={params.categorias} />
        ...
        <div align="center" className="row">
          <div className="col-lg-6 col-md-6 col-sm-12 col-12">
            <div style={{ marginTop: '1.5em' }} className="table-responsive">
          ...
          <div className="col-lg-6 col-md-6 col-sm-12 col-12">
            <label>
              ...
              <select onChange={cambioCartera} className="form-select rounded" aria-label="Default select example" value={carteraSeleccionada} >
                {params.carterasIds.map((item, index) => {
                  return (
      ...
      <h1 style={{ fontSize: '1.5em', marginTop: '0.5em' }} id="titulo" className="text-center">Lista de gastos</h1>
      <div className='container'>
      ...
      <NuevoGasto token={params.token} categorias={params.categorias} carteraSeleccionada={carteraSeleccionada}></NuevoGasto>
    </AuthenticatedLayout>
  )
}
