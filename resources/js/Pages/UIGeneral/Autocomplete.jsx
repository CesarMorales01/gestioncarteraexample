...
function AutoComplete(params) {
    ...
    function buscarClientesArray(newValue) {
        ...
        document.getElementById('btnDialogoBuscarClient').click()
    }
    ...
    return (
        <div >
            ...
            <button id='btnDialogoBuscarClient' type='button' data-toggle="modal" data-target="#dialogoSearchClients"></button>
            <DialogoBuscarClient encontrados={encontrados}></DialogoBuscarClient>
        </div>
    )
}
